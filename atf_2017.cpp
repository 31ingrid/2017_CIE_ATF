...
#include <atf_2017.htp>

model_data::model_data(int argc,char * argv[]) : ad_comm(argc,argv)
{
  pad_evalout = new ofstream("atf_2016_1b.mcmc.out");       ;
  styr.allocate("styr");
 ...
 model_data(argc,argv) , function_minimizer(sz)
{
  ...
  #endif
  avgsel_srv2.allocate(1,2,"avgsel_srv2");
  #ifndef NO_AD_INITIALIZE
    avgsel_srv2.initialize();
  #endif
...
void model_parameters::set_runtime(void)
{
  ...
  dvector temp("{1e-4 1e-4 1e-5 1e-6}");
